...
RECIPIENT_EMAIL=your_recipient_email      # Where inquiry emails are sent
```
...
│   ├── InquiryForm.jsx         # Contact form with validation & state
...
- **POST /api/contact** (app/api/contact/route.js)
  - Accepts wedding inquiry form submissions
  - Features:
...
**InquiryForm.jsx** (Most Complex Component)
...
- **Client when needed** (page.jsx, InquiryForm.jsx)
...
5. **No user accounts** - Single-purpose wedding inquiry site
...
- To store inquiries: add Prisma/MongoDB/Supabase
